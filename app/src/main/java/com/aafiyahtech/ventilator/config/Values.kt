...
const val oxygenRateMax = 100

/* group 1 b */
const val respiratoryRateDefault = 12
...
const val triggerPressureMax = 5.0

const val triggerFlowDefault = 1
const val triggerFlowMin = 0.5
const val triggerFlowMax = 5.0
...
const val minPressureMax = 10

const val maxPressureDefault = 25
const val maxPressureMin = 5
const val maxPressureMax = 45

const val minAirFlowDefault = 0.1
const val minAirFlowMin = 0.1
...
const val minOxygenMax = 50

const val maxOxygenDefault = 95
const val maxOxygenMin = 50
const val maxOxygenMax = 100
